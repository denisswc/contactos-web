...
public class OperacionesPC {
    ...
    public void modificaCompu(Computadora c){
        try {
            ...
            pstModificar.setString(1, c.getMarca());
            pstModificar.setString(2, c.getProcesador());
            pstModificar.setInt(3, c.getMemoria());
            pstModificar.setString(4, c.getDisco());
            pstModificar.setInt(5, c.getMemoria_video());
            pstModificar.setString(6,c.getDescripcion());
            pstModificar.setInt(7, c.getId());
...
//      cn=DriverManager.getConnection(this.url);
    ...
    public void insertaCompu(Computadora c){
        try {
            ...
            pstInsertar.setInt(4, c.getMemoria());
            pstInsertar.setString(5, c.getDisco());
            pstInsertar.setInt(6, c.getMemoria_video());
            pstInsertar.setString(7, c.getDescripcion());
