...
<html>
	<head>
		<title>Eliminar Sitio Web</title>
	</head>
<jsp:useBean id="webe" scope="request" class="javabeans.Web" />
<jsp:setProperty name="webe" property="*"/>
<%if(request.getParameter("direccion_website")!=null && request.getParameter("direccion_website")!=""){%>
   <jsp:forward page="controladorweb?operacion=elimina"/>
<%}%>
<body>
<div>
  <h1>Eliminar Sitio Web</h1>
  <form method="post">
  <br/><br/>
