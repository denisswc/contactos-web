...
<jsp:useBean id="web" scope="request" class="javabeans.Web" />
<jsp:setProperty name="web" property="*"/>
<%if(request.getParameter("direccion_website")!=null && request.getParameter("direccion_website")!=""){%>
   <jsp:forward page="../controladorweb?operacion=grabar"/>
<%}%>
<body>
<div>
  <h1>Agregar Sitio Web</h1>
  <form method="post">
  <br/><br/>
